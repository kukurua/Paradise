...
/datum/ai_laws/deathsquad/New()
	...
	add_inherent_law("Уничтожьте все органические и синтетические формы жизни, кроме себя, привязанных к вам юнитов, членов Эскадрона Смерти и членов Центрального Командования.")
	..()
